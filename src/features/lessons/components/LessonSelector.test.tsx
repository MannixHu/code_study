...
describe('LessonSelector', () => {
  ...
  describe('Rendering', () => {
    it('should render lesson selector with all lessons', () => {
      ...
      expect(screen.getByRole('option', { name: /First Component/i })).toBeInTheDocument()
      expect(screen.getByRole('option', { name: /Props and State/i })).toBeInTheDocument()
      expect(screen.getByRole('option', { name: /Advanced Hooks/i })).toBeInTheDocument()
    })
    ...
    it('should display estimated time in options', () => {
      ...
      expect(screen.getByRole('option', { name: /10min/i })).toBeInTheDocument()
      expect(screen.getByRole('option', { name: /15min/i })).toBeInTheDocument()
      expect(screen.getByRole('option', { name: /20min/i })).toBeInTheDocument()
    })
  })
  ...
  describe('User Interactions', () => {
    it('should call onLessonChange when lesson is selected', async () => {
      ...
      render(<LessonSelector {...defaultProps} onLessonChange={handleChange} />)
