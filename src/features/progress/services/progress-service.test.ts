...
describe("ProgressService", () => {
  ...
  describe("recordProgress", () => {
    it("should record progress for a new lesson", async () => {
      ...
      const result = await progressService.recordProgress(
        "lesson-1",
        testResults,
        "const App = () => {}",
      );
  ...
  describe("calculateStatistics", () => {
    ...
    it("should calculate statistics for specific category", async () => {
      ...
      mockProgressRepository.getProgressByCategory.mockResolvedValue(
        mockProgress,
      );
      ...
      expect(mockProgressRepository.getProgressByCategory).toHaveBeenCalledWith(
        "jsx-basics",
      );
    });
  ...
  describe("clearProgress", () => {
    it("should clear progress for a lesson", async () => {
      ...
      expect(result.success).toBe(true);
      expect(mockProgressRepository.deleteProgress).toHaveBeenCalledWith(
        "lesson-1",
      );
    });

    it("should handle errors", async () => {
      mockProgressRepository.deleteProgress.mockRejectedValue(
  ...
  describe("warmupCache", () => {
    ...
    it("should handle errors", async () => {
      mockProgressRepository.warmupCache.mockRejectedValue(
