...
describe('useTestRunner', () => {
  ...
  describe('runTests', () => {
    ...
    it('should set isRunningTests to false after tests complete', async () => {
      ...
      expect(mockProgressState.setIsRunningTests).toHaveBeenLastCalledWith(false)
    })
    ...
    it('should set test results on success', async () => {
      ...
      expect(mockProgressState.setTestResults).toHaveBeenCalledWith(mockTestResults)
    })
  ...
  describe('saveProgress', () => {
    ...
    it('should add completed lesson when completed', async () => {
      ...
      expect(mockProgressState.addCompletedLesson).toHaveBeenCalledWith('lesson-1')
    })
    ...
    it('should return false on exception', async () => {
      mockProgressService.recordProgress.mockRejectedValue(new Error('Network error'))
